...
public:
  ...
  void Load(gazebo::physics::ModelPtr _model, sdf::ElementPtr _sdf) override {
    ...
    sub_ = node_->create_subscription<std_msgs::msg::Float64MultiArray>(
      "/prop_vel", 10, std::bind(&DronePlugin::ActivateCallback, this, std::placeholders::_1));
  ...
  void OnUpdate() {
    ...
    double thrustbl = calculateThrust2side(propvel[3]);
  ...
  double calculateThrust2side(double w) {
    return sgn(w) * rotor_thrust_coeff * w * w;
  }
