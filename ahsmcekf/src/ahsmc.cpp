...
public:
    ...
    void stateCallback(const std_msgs::msg::Float64MultiArray::SharedPtr msg) {
        ...
        //std::ofstream outfile1("dataahsmc/dataahsmcxyz.txt", std::ios_base::app);
        //if (outfile1.is_open()) {
        ...
        //std::ofstream outfile2("dataahsmc/dataahsmcrpy.txt", std::ios_base::app);
        //if (outfile2.is_open()) {
        ...
        //std::ofstream outfile3("dataahsmc/dataahsmccontrol.txt", std::ios_base::app);
        //if (outfile3.is_open()) {
