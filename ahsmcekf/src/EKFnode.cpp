...
{
public:
  EKFNode(): Node("ekf_node"), Q(MatrixXd::Identity(12, 12) * 1e-5), R(MatrixXd::Identity(12, 12) * 1e-6), m(2.11), g(9.81),
        Kdx(0.0000267), Kdy(0.0000267), Kdz(0.0000625), Ixx(0.0785), Iyy(0.0785), Izz(0.105),
        Pk(MatrixXd::Zero(12, 12)), xkh(VectorXd::Zero(12)), U(VectorXd::Zero(4)), dt(0.0025), last_time_(this->now())
  {
